...
u1.videos.attach(io: v1, filename: 'candle_flicker.mp4')
u2.videos.attach(io: v2, filename: 'candle_stock.mp4')
u3.videos.attach(io: v3, filename: 'creepy_doll.mp4')
u4.videos.attach(io: v4, filename: 'decomposing_doll.mp4')
u5.videos.attach(io: v5, filename: 'ghost_doll.mp4')
u6.videos.attach(io: v6, filename: 'red_sky.mp4')
u7.videos.attach(io: v7, filename: 'moon_and_cloud.mp4')
u8.videos.attach(io: v8, filename: 'light_flicker.mp4')
u9.videos.attach(io: v9, filename: 'hong_kong.mp4')
