...
u1.videos.attach(io: c1, filename: 'candle_flicker.mp4')
u2.videos.attach(io: c2, filename: 'candle_stock.mp4')
u3.videos.attach(io: c3, filename: 'creepy_doll.mp4')
u4.videos.attach(io: c4, filename: 'decomposing_doll.mp4')
u5.videos.attach(io: c5, filename: 'ghost_doll.mp4')
u6.videos.attach(io: c6, filename: 'red_sky.mp4')
u7.videos.attach(io: c7, filename: 'moon_and_cloud.mp4')
u8.videos.attach(io: c8, filename: 'light_flicker.mp4')
u9.videos.attach(io: c9, filename: 'hong_kong.mp4')
